...
public class DoctorProfileJFrame extends javax.swing.JFrame {
    ...
    public DoctorProfileJFrame() {
        initComponents();
        details = doctor_da.getData(DoctorJFrame.doctorId);
        MID = doctor_da.getmobileId(DoctorJFrame.doctorId);
        MNO = doctor_da.getmobileNo(DoctorJFrame.doctorId);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        oldpass = doctor_da.getpassword(DoctorJFrame.doctorId);
        if (newpass.compareTo(confirmpass)==0) {
            doctor_da.updatepassword(doctor_da.useridfordid(DoctorJFrame.doctorId), newpass);
