 ...
 */
public class PrescriptionDataAccessManager {
     ...
     * @param dbCon
     */
    public synchronized static PrescriptionDataAccessManager getConnection(DbConnectionManager dbCon) {
        if (singleton == null) {
            singleton = new PrescriptionDataAccessManager(dbCon);
            return singleton;
        } else {
            return singleton;
        }
    ...
    public synchronized static PrescriptionDataAccessManager getConnection() {
        if (singleton == null) {
            singleton = new PrescriptionDataAccessManager(dbCon);
            return singleton;
        } else {
    ...
    private PrescriptionDataAccessManager(DbConnectionManager dbCon) {
        this.dbCon = dbCon;
    }
