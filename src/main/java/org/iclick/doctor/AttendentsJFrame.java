...
public class AttendentsJFrame extends javax.swing.JFrame {
    ...
    public void updateTable() {
        ...
        Patient chnPatient = new Patient(Patient_DA.getConnection(), dateNow);
        patient_id_list = chnPatient.getupdatedList(Patient_DA.getConnection(), dateNow, selecteddoctorid);
...
//        int Patient_ID = (int)model.getValueAt(patientListTable.getSelectedRow(), 0);
        ...
        Patient thePatient = new Patient(Patient_ID, Patient_DA.getConnection());
        Prescription MediCard = new Prescription(Prescription_DA.getConnection());
